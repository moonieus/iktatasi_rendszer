...
while($row=$stmt->fetch()){
	extract($row);
	$tbl.="<tr><td>{$felhasznalo}</td><td>{$jogosultsag}</td><td>{$jelszo}</td>";           
	...
	$tbl.="<td class=' btn btn-outline-primary  m-1'><a class='text-danger' href='index.php?p=felhasznalok.php&deleteId=$azonosito'>Törlés</a></td></tr>";
}	
?>

<div class="container border">
  <h2 class="text-center">Felhasználók kezelése</h6>
  <div class="row">
  ...
  <div class="btn btn-outline-light m-1 p-1 rounded"><a  href="index.php?p=alkalmazottak.php&insert=insert.php"><b>Új felhasználó rögzítése</b></a></div>
